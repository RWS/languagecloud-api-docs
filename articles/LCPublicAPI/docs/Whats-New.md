...
- Enforce validations related to the length of the _name_ and _description_ fields and the accepted input values for the Create and Update Project endpoints will be delivered in 6 months.
