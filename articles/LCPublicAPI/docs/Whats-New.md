...
- The [List Custom Field Definitions](../api/Public-API.v1-fv.html#/operations/ListCustomFields) endpoint has been extended with a `resourceType` query parameter, allowing you to filter custom fields by resource type.
