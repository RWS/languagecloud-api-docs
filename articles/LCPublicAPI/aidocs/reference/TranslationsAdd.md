# Trados Cloud Platform API Add Translation Unit

Add Translation Unit TranslationsAdd POST /translations/translation-unit

- Friendly name: Add Translation Unit
- Operation ID: TranslationsAdd
- HTTP Method: POST
...
- Schema: translation-add-request (see model section below)
...
## Model: translation-add-request
<a id="translation-add-request"></a>
...
properties:
  ...
  - settings: $ref: #/components/schemas/translation-add-settings
```
...
## Model: translation-add-settings
<a id="translation-add-settings"></a>
...
properties:
  ...
  - ifTargetSegmentsDiffer: type: string enum: [addNew, overwrite, leaveUnchanged, keepMostRecent, merge]
```
...
```csharp
Task TranslationsAddAsync(string fields = null);
```
...
```java
// POST /translations/translation-unit?fields={fields}
TranslationUnitAddUpdateResponse translationsAdd(String fields, TranslationAddRequest translationAddRequest);
```

| Parameter | Type | Required |
|---|---|---|
| `fields` | `String` | no |
| `translationAddRequest` | `TranslationAddRequest` | no |