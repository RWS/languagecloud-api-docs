...
<a id="list-project-templates-response"></a>
...
```csharp
Task<ListProjectTemplatesResponse> ListProjectTemplatesAsync(string name = null, int? top = null, int? skip = null, IEnumerable<string> location, LocationStrategy? locationStrategy = null, string sort = null, string fields = null);
```
...
ListProjectTemplatesResponse listProjectTemplates(String name, Integer top, Integer skip, List<String> location, String locationStrategy, String sort, String fields);
```
