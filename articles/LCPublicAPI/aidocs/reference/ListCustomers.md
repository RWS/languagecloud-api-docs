...
<a id="list-customers-response"></a>
...
```csharp
Task<ListCustomersResponse> ListCustomersAsync(int? top = null, int? skip = null, IEnumerable<string> location, LocationStrategy? locationStrategy = null, string sort = null, string fields = null);
```
...
ListCustomersResponse listCustomers(Integer top, Integer skip, List<String> location, String locationStrategy, String sort, String fields);
```
