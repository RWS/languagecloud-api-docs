# Trados Cloud Platform API List Termbase Entries

List Termbase Entries ListTermbaseEntries GET /termbases/{termbaseId}/entries

- Friendly name: List Termbase Entries
- Operation ID: ListTermbaseEntries
- HTTP Method: GET
...
- **humanReadableIds** (query, array) - optional: Can provide a list of humanReadableId from entries to filter by.
...
- Schema: list-termbase-entries-response (see model section below)
...
## Model: list-termbase-entries-response
<a id="list-termbase-entries-response"></a>
...
```csharp
Task<ListTermbaseEntriesResponse> ListTermbaseEntriesAsync(string termbaseId, int? top = null, int? skip = null, string fields = null, IEnumerable<string> humanReadableIds);
```
...
| `skip` | `int` | no |
| `fields` | `string` | no |
| `humanReadableIds` | `IEnumerable<string>` | yes |

### Java — `TermbaseApi`

```java
// GET /termbases/{termbaseId}/entries?top={top}&skip={skip}&fields={fields}&humanReadableIds={humanReadableIds}
ListTermbaseEntriesResponse listTermbaseEntries(String termbaseId, Integer top, Integer skip, String fields, List<String> humanReadableIds);
```
...
| `skip` | `Integer` | no |
| `fields` | `String` | no |
| `humanReadableIds` | `List<String>` | no |