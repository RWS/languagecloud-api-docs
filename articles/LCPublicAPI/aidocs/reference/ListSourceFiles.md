...
<a id="list-source-files-response"></a>
...
```csharp
Task<ListSourceFilesResponse> ListSourceFilesAsync(string projectId, int? top = null, int? skip = null, string sort = null, string fields = null);
```
