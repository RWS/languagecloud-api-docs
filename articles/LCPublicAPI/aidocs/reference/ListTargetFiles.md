...
<a id="list-target-files-response"></a>
...
```csharp
Task<ListTargetFilesResponse> ListTargetFilesAsync(string projectId, IEnumerable<string> targetFileIds, IEnumerable<string> sourceFileIds, int? top = null, int? skip = null, string fields = null);
```

| Parameter | Type | Required |
|---|---|---|
| `projectId` | `string` | yes |
| `targetFileIds` | `IEnumerable<string>` | yes |
| `sourceFileIds` | `IEnumerable<string>` | yes |
| `top` | `int` | no |
| `skip` | `int` | no |
| `fields` | `string` | no |
...
```java
// GET /projects/{projectId}/target-files?targetFileIds={targetFileIds}&sourceFileIds={sourceFileIds}&top={top}&skip={skip}&fields={fields}
ListTargetFilesResponse listTargetFiles(String projectId, List<String> targetFileIds, List<String> sourceFileIds, Integer top, Integer skip, String fields);
```

| Parameter | Type | Required |
|---|---|---|
| `projectId` | `String` | yes |
| `targetFileIds` | `List<String>` | no |
| `sourceFileIds` | `List<String>` | no |
| `top` | `Integer` | no |
| `skip` | `Integer` | no |
| `fields` | `String` | no |