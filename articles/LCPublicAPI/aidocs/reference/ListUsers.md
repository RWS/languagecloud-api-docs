# Trados Cloud Platform API List Users

List Users ListUsers GET /users

- Friendly name: List Users
...
- Schema: list-users-response (see model section below)
...
## Model: list-users-response
<a id="list-users-response"></a>
...
```csharp
Task<ListUsersResponse> ListUsersAsync(int? top = null, int? skip = null, IEnumerable<string> location, LocationStrategy? locationStrategy = null, string sort = null, string fields = null);
```
...
```java
// GET /users?top={top}&skip={skip}&location={location}&locationStrategy={locationStrategy}&sort={sort}&fields={fields}
ListUsersResponse listUsers(Integer top, Integer skip, List<String> location, String locationStrategy, String sort, String fields);
```
