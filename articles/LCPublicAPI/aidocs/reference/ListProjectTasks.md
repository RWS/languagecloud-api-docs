...
```csharp
Task<ListProjectTasksResponse> ListProjectTasksAsync(string projectId, int? top = null, int? skip = null, IEnumerable<string> location, LocationStrategy? locationStrategy = null, string sort = null, string fields = null);
```
...
ListTasksResponse listProjectTasks(String projectId, Integer top, Integer skip, List<String> location, String locationStrategy, String sort, String fields);
```
