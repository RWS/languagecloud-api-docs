...
<a id="perfect-match-mapping-create-request"></a>
...
<a id="perfect-match-mapping-create-response"></a>
...
<a id="perfect-match-batch-mapping-created-response"></a>
...
```csharp
Task<PerfectMatchMapping> CreatePerfectMatchMappingAsync(PerfectMatchMappingCreateRequest fields = null);
```
